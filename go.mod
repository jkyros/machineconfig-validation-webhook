module github.com/jkyros/machineconfig-validation-webhook
...
require (
	...
	github.com/openshift/api v0.0.0-20230221095031-69130006bb23 // indirect
...
replace github.com/openshift/machine-config-operator => github.com/openshift/machine-config-operator v0.0.1-0.20230518024741-655ba3328198
